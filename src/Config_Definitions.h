...
#define BATTERY_TYPE BATTERY_TYPE_LI_FE_PO4 // Choose from BATTERY_TYPE_LI_ION or BATTERY_TYPE_LI_FE_PO4 for Ignitron internal battery or BATTERY_TYPE_AMP for Spark battery
const int BATTERY_CELLS = 3;
const float VOLTAGE_DIVIDER_R1 = (22 * 1000);    // 22 kohm
const float VOLTAGE_DIVIDER_R2 = (24.2 * 1000);  // 24.2 kohm
...
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_90 = (BATTERY_CELLS * 2.60);
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_50 = (BATTERY_CELLS * 2.4);
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_10 = (BATTERY_CELLS * 1.9);
...
// Amp Mode hardware toggle
//#define AMP_MODE_SWITCH_PIN 35   // choose an unused GPIO, SPST toggle to GND
